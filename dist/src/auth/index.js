...
exports.validateHMAC = exports.Error = exports.OAUTH_ENABLE_COOKIES_PATH = exports.OAUTH_CALLBACK_PATH = exports.OAUTH_INLINE_PATH = exports.OAUTH_START_PATH = exports.GRANTED_STORAGE_ACCESS_COOKIE_NAME = exports.TEST_COOKIE_NAME = exports.TOP_LEVEL_OAUTH_COOKIE_NAME = void 0;
...
exports.OAUTH_START_PATH = '/auth';
exports.OAUTH_INLINE_PATH = '/auth/inline';
exports.OAUTH_CALLBACK_PATH = '/auth/callback';
exports.OAUTH_ENABLE_COOKIES_PATH = '/auth/callback/enable_cookies';
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!(ctx.path === exports.OAUTH_START_PATH &&
                            !hasCookieAccess(ctx) &&
                    ...
                    case 1:
                        ...
                        return [2 /*return*/];
                    case 2:
                        if (!(ctx.path === exports.OAUTH_INLINE_PATH ||
                            (ctx.path === exports.OAUTH_START_PATH && shouldPerformInlineOAuth(ctx)))) return [3 /*break*/, 4];
                        return [4 /*yield*/, oAuthStart(ctx)];
                    case 3:
                        _a.sent();
                        return [2 /*return*/];
                    case 4:
                        if (!(ctx.path === exports.OAUTH_START_PATH)) return [3 /*break*/, 6];
                        return [4 /*yield*/, topLevelOAuthRedirect(ctx)];
                    case 5:
                        _a.sent();
                        return [2 /*return*/];
                    case 6:
                        if (!(ctx.path === exports.OAUTH_CALLBACK_PATH)) return [3 /*break*/, 8];
                        return [4 /*yield*/, oAuthCallback(ctx)];
                    case 7:
                        _a.sent();
                        return [2 /*return*/];
                    case 8:
                        if (!(ctx.path === exports.OAUTH_ENABLE_COOKIES_PATH)) return [3 /*break*/, 10];
